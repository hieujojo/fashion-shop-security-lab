...
export default function ProductDetail() {
  ...
  if (!product) return <div className="max-w-6xl mx-auto mt-8">Loading...</div>;
    ...
    <div className="max-w-6xl mx-auto mt-8 px-4">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-gray-100 h-96 flex items-center justify-center rounded">
          <img src={product.image_url} alt={product.name} className="h-full w-full object-cover rounded" />
        </div>
        <div>
